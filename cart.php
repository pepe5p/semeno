...
<body>
    ...
    <main>
        <div class="longBar hBar">
            <header class="centerBox leftPad title">TWÓJ KOSZYK</header>
        </div>
        <div class="centerBox">
                                                            ...
                                                            <div class="container-fluid">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-7 col-lg-9 noPadding">
                                                                        <div class="borderTileTop one_third_height descTile">
                                                                            <div class="container-fluid vertAlign">
                                                                                <div class="row">
                                                                                    <div class="desc col-12 noPadding">
                                                                                        <a class="s2" href="product.php?prod_id=$prod_id&name=$name">$name ($size)</a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="borderTileMiddle one_third_height descTile">
                                                                            <div class="container-fluid vertAlign">
                                                                                <div class="row">
                                                                                    <div class="desc col-12 noPadding">
                                                                        ...
                                                                        <div class="borderTileBottom one_third_height descTile">
                                                                            <div class="container-fluid vertAlign">
                                                                                <div class="row">
                                                                                    <div class="desc col-3 noPadding title">
                                                                                    ...
                                                                                    <div class="desc col-3 noPadding title">
                                                                                        <a href="php/getchange_quantity.php?order_id=$order_id&quantity=$quantity&sign=delete"><i class="icon-cancel"></i></a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
...
END;
                    ...
                    <div class="col-12 col-md-6 padding">
                        <form action="buying.php" method="post" class="tile autoHeight">
                                    ...
                                    <div class="col-6 noPadding">
                                        <div class="descTile title">
                                            <span class="vertAlign">
                                                <?php 
                                                    if($connection->connect_errno == 0 && isset($all_price))
                                                    {
                                                        echo "$all_price PLN";
                                                        echo "<input name='all_price' value='$all_price' type='hidden' disabled/>";
                                                    }
                                                    else echo "0 PLN";
                                                ?>
                                            </span>
